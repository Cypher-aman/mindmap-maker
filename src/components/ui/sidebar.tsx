...
const Sidebar: React.FC<SidebarProps> = ({ open, setOpen, nodeId }) => {
  ...
  return (
    <>
      <div
        className={`fixed top-0 left-0 w-screen ease-linear bottom-0 transition-all duration-300 z-30 bg-black/50 ${
